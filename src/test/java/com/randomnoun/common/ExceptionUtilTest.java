...
public class ExceptionUtilTest extends TestCase {
	...
	public void testGetStackTrace() {
		...
		assertEquals(baos.toString(), ExceptionUtil.getStackTrace(e));
	...
	public void testGetStackTraceWithRevisionsNoHighlight() {
		...
		e.printStackTrace(new PrintStream(baos));
		highlightedStackTrace = ExceptionUtil.getStackTraceWithRevisions(e, 
			this.getClass().getClassLoader(), ExceptionUtil.HIGHLIGHT_NONE, "com.randomnoun.");
		// check that our getStackTrace() method matches java's printStackTrace() method
	...
	public void testGetStackTraceWithRevisionsHtml() {
		...
		e.printStackTrace(new PrintStream(baos));
		highlightedStackTrace = ExceptionUtil.getStackTraceWithRevisions(e, 
			this.getClass().getClassLoader(), ExceptionUtil.HIGHLIGHT_HTML, "com.randomnoun.");
	...
	public void testGetStackTraceSummary() {
		...
		e.printStackTrace(new PrintStream(baos));
		summary = ExceptionUtil.getStackTraceSummary(e);
